...
public class BaseLoader : MonoBehaviour {
    ...
    public delegate void onComplete (GameObject go);
...
//		string relativePath = GetRelativePath();
    ...
    protected IEnumerator LoadFromPrefabManager (string assetBundleName, string assetName ,onComplete callBack = null,onComplete callBack2 = null)
    {
        Debug.Log("Start to load " + assetName + " at frame " + Time.frameCount);
