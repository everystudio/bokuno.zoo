...
public class MasterQuestSkillAtach : MonoBehaviour
{
	...
	public static void AtachFolder ()
	{
		...
		CreateComponents (typeof(MasterQuestSkill));
	}
	...
	public static void CreateComponents (Type _type)
	{
		...
		GameObject gameObject = EditorUtility.CreateGameObjectWithHideFlags (
			...
			typeof(MasterQuestSkillDataHolder)
		);
		...
		MasterQuestSkill tmp = new MasterQuestSkill();

		foreach (UnityEngine.Object asset in assets) {
			if (asset is MasterQuestSkill) {
				tmp = (MasterQuestSkill)asset;
			}
		}

		MasterQuestSkillDataHolder holder = gameObject.GetComponent<MasterQuestSkillDataHolder> ();
