...
public class MasterGachaAtach : MonoBehaviour
{
	...
	public static void AtachFolder ()
	{
		...
		CreateComponents (typeof(MasterGacha));
	}
	...
	public static void CreateComponents (Type _type)
	{
		...
		MasterGacha tmp = new MasterGacha();

		foreach (UnityEngine.Object asset in assets) {
			if (asset is MasterGacha) {
				tmp = (MasterGacha)asset;
			}
		}

		MasterGachaDataHolder holder = gameObject.GetComponent<MasterGachaDataHolder> ();
