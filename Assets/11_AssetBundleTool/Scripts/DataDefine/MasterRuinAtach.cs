...
public class MasterRuinAtach : MonoBehaviour
{
	...
	public static void AtachFolder ()
	{
		...
		CreateComponents (typeof(MasterRuin));
	}
	...
	public static void CreateComponents (Type _type)
	{
		...
		MasterRuin tmp = new MasterRuin();

		foreach (UnityEngine.Object asset in assets) {
			if (asset is MasterRuin) {
				tmp = (MasterRuin)asset;
			}
		}

		MasterRuinDataHolder holder = gameObject.GetComponent<MasterRuinDataHolder> ();
