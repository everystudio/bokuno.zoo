...
public class MasterSkitAtach : MonoBehaviour
{
	...
	public static void AtachFolder ()
	{
		...
		CreateComponents (typeof(MasterSkit));
	}
	...
	public static void CreateComponents (Type _type)
	{
		...
		MasterSkit tmp = new MasterSkit();

		foreach (UnityEngine.Object asset in assets) {
			if (asset is MasterSkit) {
				tmp = (MasterSkit)asset;
			}
		}

		MasterSkitDataHolder holder = gameObject.GetComponent<MasterSkitDataHolder> ();
