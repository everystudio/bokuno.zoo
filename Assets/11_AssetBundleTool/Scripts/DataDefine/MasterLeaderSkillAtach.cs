...
public class MasterLeaderSkillAtach : MonoBehaviour
{
	...
	public static void AtachFolder ()
	{
		...
		CreateComponents (typeof(MasterLeaderSkill));
	}
	...
	public static void CreateComponents (Type _type)
	{
		...
		GameObject gameObject = EditorUtility.CreateGameObjectWithHideFlags (
			...
			typeof(MasterLeaderSkillDataHolder)
		);
		...
		MasterLeaderSkill tmp = new MasterLeaderSkill();

		foreach (UnityEngine.Object asset in assets) {
			if (asset is MasterLeaderSkill) {
				tmp = (MasterLeaderSkill)asset;
			}
		}

		MasterLeaderSkillDataHolder holder = gameObject.GetComponent<MasterLeaderSkillDataHolder> ();
