...
public class MasterLoadPrefabAtach : MonoBehaviour
{
	...
	public static void AtachFolder ()
	{
		...
		CreateComponents (typeof(MasterLoadPrefab));
	}
	...
	public static void CreateComponents (Type _type)
	{
		...
		GameObject gameObject = EditorUtility.CreateGameObjectWithHideFlags (
			...
			typeof(MasterLoadPrefabDataHolder)
		);
		...
		MasterLoadPrefabDataHolder holder = gameObject.GetComponent<MasterLoadPrefabDataHolder> ();
