...
public class MasterQuizAtach : MonoBehaviour
{
	...
	public static void AtachFolder ()
	{
		...
		CreateComponents (typeof(MasterQuiz));
	}
	...
	public static void CreateComponents (Type _type)
	{
		...
		MasterQuiz tmp = new MasterQuiz();

		foreach (UnityEngine.Object asset in assets) {
			if (asset is MasterQuiz) {
				tmp = (MasterQuiz)asset;
			}
		}

		MasterQuizDataHolder holder = gameObject.GetComponent<MasterQuizDataHolder> ();
