...
public class MasterLoginBonusRewardAtach : MonoBehaviour
{
	...
	public static void AtachFolder ()
	{
		...
		CreateComponents (typeof(MasterLoginBonusReward));
	}
	...
	public static void CreateComponents (Type _type)
	{
		...
		GameObject gameObject = EditorUtility.CreateGameObjectWithHideFlags (
			...
			typeof(MasterLoginBonusRewardDataHolder)
		);
		...
		MasterLoginBonusReward tmp = new MasterLoginBonusReward();

		foreach (UnityEngine.Object asset in assets) {
			if (asset is MasterLoginBonusReward) {
				tmp = (MasterLoginBonusReward)asset;
			}
		}

		MasterLoginBonusRewardDataHolder holder = gameObject.GetComponent<MasterLoginBonusRewardDataHolder> ();
