...
public class MasterCollectionCompleteBonusAtach : MonoBehaviour
{
	...
	public static void AtachFolder ()
	{
		...
		CreateComponents (typeof(MasterCollectionCompleteBonus));
	}
	...
	public static void CreateComponents (Type _type)
	{
		...
		GameObject gameObject = EditorUtility.CreateGameObjectWithHideFlags (
			...
			typeof(MasterCollectionCompleteBonusDataHolder)
		);
		...
		MasterCollectionCompleteBonus tmp = new MasterCollectionCompleteBonus();

		foreach (UnityEngine.Object asset in assets) {
			if (asset is MasterCollectionCompleteBonus) {
				tmp = (MasterCollectionCompleteBonus)asset;
			}
		}

		MasterCollectionCompleteBonusDataHolder holder = gameObject.GetComponent<MasterCollectionCompleteBonusDataHolder> ();
