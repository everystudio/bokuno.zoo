...
public class MasterRuinSugorokuGridAtach : MonoBehaviour
{
	...
	public static void AtachFolder ()
	{
		...
		CreateComponents (typeof(MasterRuinSugorokuGrid));
	}
	...
	public static void CreateComponents (Type _type)
	{
		...
		GameObject gameObject = EditorUtility.CreateGameObjectWithHideFlags (
			...
			typeof(MasterRuinSugorokuGridDataHolder)
		);
		...
		MasterRuinSugorokuGrid tmp = new MasterRuinSugorokuGrid();

		foreach (UnityEngine.Object asset in assets) {
			if (asset is MasterRuinSugorokuGrid) {
				tmp = (MasterRuinSugorokuGrid)asset;
			}
		}

		MasterRuinSugorokuGridDataHolder holder = gameObject.GetComponent<MasterRuinSugorokuGridDataHolder> ();
