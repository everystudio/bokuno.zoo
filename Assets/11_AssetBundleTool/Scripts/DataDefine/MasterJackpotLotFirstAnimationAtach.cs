...
public class MasterJackpotLotFirstAnimationAtach : MonoBehaviour
{
	...
	public static void AtachFolder ()
	{
		...
		CreateComponents (typeof(MasterJackpotLotFirstAnimation));
	}
	...
	public static void CreateComponents (Type _type)
	{
		...
		GameObject gameObject = EditorUtility.CreateGameObjectWithHideFlags (
			...
			typeof(MasterJackpotLotFirstAnimationDataHolder)
		);
		...
		MasterJackpotLotFirstAnimation tmp = new MasterJackpotLotFirstAnimation();

		foreach (UnityEngine.Object asset in assets) {
			if (asset is MasterJackpotLotFirstAnimation) {
				tmp = (MasterJackpotLotFirstAnimation)asset;
			}
		}

		MasterJackpotLotFirstAnimationDataHolder holder = gameObject.GetComponent<MasterJackpotLotFirstAnimationDataHolder> ();
