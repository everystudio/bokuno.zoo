...
public class MasterCardAtach : MonoBehaviour
{
	...
	public static void AtachFolder ()
	{
		...
		CreateComponents (typeof(MasterCard));
	}
	...
	public static void CreateComponents (Type _type)
	{
		...
		MasterCard tmp = new MasterCard();

		foreach (UnityEngine.Object asset in assets) {
			if (asset is MasterCard) {
				tmp = (MasterCard)asset;
			}
		}

		MasterCardDataHolder holder = gameObject.GetComponent<MasterCardDataHolder> ();
