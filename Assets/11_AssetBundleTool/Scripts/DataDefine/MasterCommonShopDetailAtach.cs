...
public class MasterCommonShopDetailAtach : MonoBehaviour
{
	...
	public static void AtachFolder ()
	{
		...
		CreateComponents (typeof(MasterCommonShopDetail));
	}
	...
	public static void CreateComponents (Type _type)
	{
		...
		GameObject gameObject = EditorUtility.CreateGameObjectWithHideFlags (
			...
			typeof(MasterCommonShopDetailDataHolder)
		);
		...
		MasterCommonShopDetail tmp = new MasterCommonShopDetail();

		foreach (UnityEngine.Object asset in assets) {
			if (asset is MasterCommonShopDetail) {
				tmp = (MasterCommonShopDetail)asset;
			}
		}

		MasterCommonShopDetailDataHolder holder = gameObject.GetComponent<MasterCommonShopDetailDataHolder> ();
