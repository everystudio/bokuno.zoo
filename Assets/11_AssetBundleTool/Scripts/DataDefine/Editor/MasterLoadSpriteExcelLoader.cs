...
public class MasterLoadSpriteExcelLoader : EditorWindow
{
	...
	{
		ReadExcel (typeof( MasterLoadSprite));
	}
	...
	/// データの書き込み.
	/// </summary>
	public static void WriteExcelData ( List<MasterLoadSprite.Data> listData, Type _dataType, Type _dataTypeSrc)
	{
