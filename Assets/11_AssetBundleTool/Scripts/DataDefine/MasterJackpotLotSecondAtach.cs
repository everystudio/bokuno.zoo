...
public class MasterJackpotLotSecondAtach : MonoBehaviour
{
	...
	public static void AtachFolder ()
	{
		...
		CreateComponents (typeof(MasterJackpotLotSecond));
	}
	...
	public static void CreateComponents (Type _type)
	{
		...
		GameObject gameObject = EditorUtility.CreateGameObjectWithHideFlags (
			...
			typeof(MasterJackpotLotSecondDataHolder)
		);
		...
		MasterJackpotLotSecond tmp = new MasterJackpotLotSecond();

		foreach (UnityEngine.Object asset in assets) {
			if (asset is MasterJackpotLotSecond) {
				tmp = (MasterJackpotLotSecond)asset;
			}
		}

		MasterJackpotLotSecondDataHolder holder = gameObject.GetComponent<MasterJackpotLotSecondDataHolder> ();
